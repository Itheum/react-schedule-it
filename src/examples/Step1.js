          ...
          <form id="Form" className="form-horizontal">
            <div className="form-group">
              <label className="col-md-12 control-label">
                ...
                <h3>Source, Installation Instructions and Docs can be found here: <a href="https://github.com/newbreedofgeek/react-schedule-it" target="_blank">https://github.com/newbreedofgeek/react-schedule-it</a></h3>
              </label>
              <div className="row">
